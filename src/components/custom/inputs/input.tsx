  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className={`${className} ${borderRadiusStyles[input_style]} relative z-20 w-full border-[3px] border-gray-900 bg-white px-4 py-3 font-bold outline-none hover:-translate-x-[1px] hover:-translate-y-[1px] focus:translate-x-[1.5px] focus:translate-y-[1.5px]`}
